...
%     end
    i
%     load([features_dir,'Feat_',num2str(i)]);
...
%         end
    ...
    [feature_vecs_song, labels_song, start_loc, flag] = get_feature_vecs(features{i,j}, length_of_sample, time_data, 22050, 1024);
%     [feature_vecs_song, labels_song, start_loc, flag] = get_feature_vecs(dtw_features{1,j}, length_of_sample, time_data, 22050, 1024);
    %     if flag ~= 0
